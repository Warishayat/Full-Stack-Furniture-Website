    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="w-full px-6 lg:px-12 pb-20">
        <div className="max-w-3xl mx-auto mb-20 text-center">
           ...
           <h1 className="text-5xl lg:text-7xl font-serif font-medium text-gray-900 mb-8 tracking-tighter">Shipping & Delivery</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
           <div className="space-y-8">
              <div className="flex gap-8 p-10 bg-[#F2EDE7] rounded-sm border border-gray-100">
                 ...
                 <div>
                    <h3 className="text-2xl font-serif font-medium text-gray-900 mb-4 tracking-tight">White-Glove Service</h3>
              ...
              <div className="flex gap-8 p-10 bg-[#F2EDE7] rounded-sm border border-gray-100">
                 ...
                 <div>
                    <h3 className="text-2xl font-serif font-medium text-gray-900 mb-4 tracking-tight">UK Nationwide</h3>
           ...
           <div className="bg-gray-900 text-white p-12 lg:p-16 rounded-sm shadow-2xl relative overflow-hidden">
              <h3 className="text-4xl font-serif font-medium mb-12 tracking-tight">Delivery Timelines</h3>
              <div className="space-y-12">
                 <div className="flex justify-between items-end border-b border-white/10 pb-6">
                    <div>
                       <p className="text-[#D7282F] font-black uppercase tracking-widest text-[10px] mb-2">London & South</p>
                       <p className="text-2xl font-serif ">Metropolitan Delivery</p>
                    </div>
                 ...
                 <div className="flex justify-between items-end border-b border-white/10 pb-6">
                    <div>
                       ...
                       <p className="text-2xl font-serif ">Regional Logistics</p>
                    </div>
                 ...
                 <div className="flex justify-between items-end border-b border-white/10 pb-6">
                    <div>
                       ...
                       <p className="text-2xl font-serif ">Craft & Curation</p>
                    </div>
        ...
        <div className="bg-gray-50 p-12 lg:p-20 rounded-sm text-center border border-gray-100">
           ...
           <h3 className="text-4xl font-serif font-medium text-gray-900 mb-6 tracking-tighter">Fully Insured Transit</h3>
