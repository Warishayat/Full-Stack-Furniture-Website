    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="relative h-[60vh] flex items-center bg-gray-900 overflow-hidden">
        ...
        <div className="w-full px-6 lg:px-12 relative z-10">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif font-medium text-white mb-8 leading-tight tracking-tighter">
            Defining <span className=" text-white/90">British</span> <br/> Mastery
          </h1>
        </div>
      </section>
        ...
        <div className="w-full px-6 lg:px-12">
          <div className="flex flex-col lg:flex-row gap-24 items-center">
            <div className="lg:w-1/2">
              ...
              <h2 className="text-4xl lg:text-6xl font-serif font-medium text-gray-900 mb-10 leading-[1.1] tracking-tighter">
              ...
              <div className="grid grid-cols-2 gap-8 pt-6">
                 <div className="space-y-2">
                    <h4 className="text-3xl font-serif font-medium text-gray-900">15yr</h4>
                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Frame Guarantee</p>
                 </div>
                 <div className="space-y-2">
                    <h4 className="text-3xl font-serif font-medium text-gray-900">100%</h4>
            ...
            <div className="lg:w-1/2 relative">
               ...
               <div className="absolute -bottom-10 -right-10 bg-[#D7282F] p-12 text-white max-w-[280px] shadow-2xl">
                  ...
                  <p className="text-3xl font-serif font-bold  mb-2 leading-none">Heritage</p>
        ...
        <div className="w-full px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-20">
            <div className="group">
               ...
               <h3 className="text-2xl font-serif font-medium text-gray-900 mb-4 tracking-tight">Durability</h3>
            ...
            <div className="group">
               ...
               <h3 className="text-2xl font-serif font-medium text-gray-900 mb-4 tracking-tight">Artisan Finishing</h3>
            ...
            <div className="group">
               ...
               <h3 className="text-2xl font-serif font-medium text-gray-900 mb-4 tracking-tight">Ethical Sourcing</h3>
      ...
      <section className="py-32 bg-gray-900 text-white relative overflow-hidden">
         <div className="w-full px-6 lg:px-12 text-center relative z-10">
            <h2 className="text-5xl lg:text-7xl font-serif font-medium mb-12 tracking-tighter">Your sanctuary awaits.</h2>
