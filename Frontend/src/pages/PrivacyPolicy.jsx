      ...
      <div className="w-full px-6 lg:px-12 pb-20">
        <div className="max-w-4xl mx-auto">
          <div className="mb-20">
             ...
             <p className="text-gray-600 text-lg leading-relaxed font-medium">At ComfortSeating Ltd., your privacy is as important to us as your comfort. We are committed to protecting your personal data with the highest security standards.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
             <div className="p-10 bg-[#F2EDE7] rounded-sm border border-gray-100">
                <Lock className="w-8 h-8 text-[#D7282F] mb-6" />
                <h3 className="text-2xl font-serif font-medium text-gray-900 mb-4 tracking-tight">Encryption</h3>
             ...
             <div className="p-10 bg-[#F2EDE7] rounded-sm border border-gray-100">
                ...
                <h3 className="text-2xl font-serif font-medium text-gray-900 mb-4 tracking-tight">Transparency</h3>
          ...
          <div className="space-y-12 text-gray-900">
             <div>
                <h2 className="text-3xl font-serif font-medium mb-6 tracking-tight">Data Collection</h2>
             ...
             <div>
                <h2 className="text-3xl font-serif font-medium mb-6 tracking-tight">Your Rights</h2>
                <p className="text-gray-600 leading-relaxed mb-6 font-medium">
             ...
             <div>
                <h2 className="text-3xl font-serif font-medium mb-6 tracking-tight">Cookies</h2>
                <p className="text-gray-600 leading-relaxed mb-6 font-medium">
             ...
             <div className="mt-24 p-12 bg-gray-900 text-white rounded-sm border border-gray-800 flex items-center justify-between gap-10">
                <div>
                   <div className="flex items-center gap-4 mb-4">
                      ...
                      <h3 className="text-2xl font-serif font-medium  tracking-tight">Last Updated</h3>
                   </div>
