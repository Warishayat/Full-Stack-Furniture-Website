        ...
        <div className="flex flex-col lg:flex-row gap-20">
          ...
          <div className="lg:w-1/3">
            <div className="p-10 bg-[#F2EDE7] rounded-sm border border-gray-100">
               <div className="w-20 h-20 bg-gray-900 text-white rounded-full flex items-center justify-center text-3xl font-serif font-medium mb-6">
                  {user.name?.charAt(0).toUpperCase() || 'U'}
               </div>
               <h2 className="text-3xl font-serif font-medium text-gray-900 tracking-tighter mb-2">
                  Welcome, <span className=" text-[#D7282F]">{user.name?.split(' ')[0]}</span>
               </h2>
          ...
          <div className="lg:w-2/3">
            {user.role === 'admin' && (
              <div className="mb-12 p-10 bg-gray-900 text-white rounded-sm border border-gray-800">
                 <div className="flex items-center gap-4 mb-4">
                    ...
                    <h3 className="text-2xl font-serif font-medium  tracking-tight">Administrative Access</h3>
                 </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
               {menuItems.map((item, idx) => (
                 ...
                 >
                    ...
                    <h3 className="text-2xl font-serif font-medium text-gray-900 mb-2 tracking-tight">{item.title}</h3>
            ...
            <div className="mt-12 p-10 bg-gray-900 text-white rounded-sm flex items-center justify-between gap-10">
               <div>
                  <h3 className="text-2xl font-serif font-medium  mb-2 tracking-tight">Need assistance?</h3>
