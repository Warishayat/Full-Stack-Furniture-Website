      ...
      <div className="w-full px-6 lg:px-12 pb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 mb-32">
           {[
             ...
             { icon: Heart, title: 'Care Program', desc: 'Annual maintenance tips and professional cleaning discounts for all ComfortSitting members.' }
           ].map((item, idx) => (
        ...
        <div className="max-w-5xl mx-auto bg-gray-900 text-white rounded-sm overflow-hidden flex flex-col lg:flex-row shadow-2xl">
           ...
           <div className="lg:w-1/2 relative min-h-[400px]">
              <img src="https://images.unsplash.com/photo-1581539250439-c96689b516dd?q=80&w=2628&auto=format&fit=crop" className="absolute inset-0 w-full h-full object-cover opacity-60" alt="ComfortSitting Craftsmanship" />
