        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
             <div className="p-10 bg-[#F2EDE7] rounded-sm border border-gray-100">
                ...
                <h3 className="text-2xl font-serif font-medium text-gray-900 mb-4 tracking-tight">14-Day Window</h3>
             ...
             <div className="p-10 bg-[#F2EDE7] rounded-sm border border-gray-100">
                ...
                <h3 className="text-2xl font-serif font-medium text-gray-900 mb-4 tracking-tight">Concierge Collection</h3>
          ...
          <div className="space-y-12 text-gray-900">
             <div>
                <h2 className="text-3xl font-serif font-medium mb-6 tracking-tight">How to Initiate a Return</h2>
             ...
             <div>
                <h2 className="text-3xl font-serif font-medium mb-6 tracking-tight">Conditions for Return</h2>
             ...
             <div className="mt-24 p-12 bg-gray-900 text-white rounded-sm border border-gray-800 flex flex-col md:flex-row items-center justify-between gap-10">
                <div className="max-w-xl">
                   <div className="flex items-center gap-4 mb-4">
                      ...
                      <h3 className="text-2xl font-serif font-medium  tracking-tight">Need help?</h3>
                   </div>
